...
\subsection{Template}\index{\_p}\index{\_pr}\index{testCase}\index{preCompute}
\begin{lstlisting}
#include <bits/stdc++.h>
using namespace std;
...
\needspace{4\baselineskip}
\subsubsection{MergeSortTreeFractional}\index{Node}\index{build}\index{query}
...
\needspace{4\baselineskip}
\subsubsection{RangeMajorityCandidates}\index{Node}\index{merge\_nodes}\index{build}\index{query\_candidates}\index{get\_frequency}\index{solve}
\begin{lstlisting}
...
\needspace{4\baselineskip}
\subsubsection{MoWithUpdates}\index{MoUpd}\index{Q}\index{U}
...
\needspace{4\baselineskip}
\subsubsection{MoWithRollback}\index{MoRollback}\index{Q}
...
\needspace{4\baselineskip}
\subsubsection{MCMF}\index{MCMF}\index{E}
...
\needspace{4\baselineskip}
\subsubsection{CliqueColouringMIS}\index{bk}\index{maxClique}\index{chromatic}\index{steinerTree}
...
\nopagebreak{\footnotesize\sffamily\color{blurb} EUCLIDEAN-LIKE ALGORITHM (类欧几里得 / AtCoder Library `floor\_sum`).\par}\nopagebreak
\begin{lstlisting}
...
\needspace{4\baselineskip}
\subsubsection{LucasAndBinomialMod}\index{lucas}\index{pw}\index{inv\_mod}\index{factNoP}\index{binomPrimePower}\index{binomAnyMod}
...
\needspace{4\baselineskip}
\subsubsection{Mint}\index{Mint}\index{buildFact}\index{C}\index{Perm}\index{Cbig}
...
\nopagebreak{\footnotesize\sffamily\color{blurb} Mobius Function μ(n) Sieve - Time: O(N), Space: O(N)\par}\nopagebreak
\begin{lstlisting}
...
\needspace{4\baselineskip}
\subsubsection{MatrixExponentiation}\index{eye}\index{mpow}
...
\needspace{4\baselineskip}
\subsubsection{SuffixAutomaton}\index{SAM}\index{S}\index{longestCommonSubstring}
...
\needspace{4\baselineskip}
\subsubsection{GeneralizedSAM}\index{GenSAM}\index{S}
...
\needspace{4\baselineskip}
\subsubsection{DivideAndConquerDP}\index{lo}\index{hi}\index{add}\index{remove}\index{Cost}\index{f}\index{store}\index{rec}\index{solve}
...
\needspace{4\baselineskip}
\subsubsection{PersistentLiChaoTree}\index{Line}\index{Node}\index{sub}
...
\needspace{4\baselineskip}
\subsubsection{DigitDP}\index{go}\index{countUpTo}\index{countRange}
...
\needspace{4\baselineskip}
\subsubsection{Core}\index{P}\index{sgn}\index{gcdll}\index{angleTo}\index{angleAt}\index{half}\index{angCmp}
...
\needspace{4\baselineskip}
\subsubsection{HalfPlaneIntersection}\index{HP}\index{hpInter}\index{halfPlaneInter}
...
\needspace{4\baselineskip}
\subsubsection{KDTree}\index{KD}\index{Node}
...
\needspace{4\baselineskip}
\subsubsection{Geometry3D}\index{P3}\index{Plane}\index{planeLine}\index{planePlane}\index{vol6}\index{tetraVolume}\index{sphereLine}\index{greatCircle}
